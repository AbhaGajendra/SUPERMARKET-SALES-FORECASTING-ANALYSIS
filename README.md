...
•	KPIs:
o	Total Sales: 1.57M
o	Total Orders: 3,003
o	Total Profit: 175.26K
o	Avg Delivery Days: 3.93
•	Breakdowns:
o	Payment Mode: COD, Online, Cards
o	Customer Segment: Consumer, Corporate, Home Office
o	Region: West, East, Central, South
o	Shipping Mode: Standard, Second Class, First Class, Same Day
o	Category & Sub-Category: Technology, Furniture, Office Supplies (Phones, Chairs, Binders)
•	Trends:
...
o	Long-term trend (2019–2021) shows cyclical fluctuations with seasonal peaks
•	State-wise Sales: 
o	California: 0.34M
o	New York: 0.19M
o	Texas: 0.12M
...
•	🔍 Comprehensive EDA across multiple dimensions (payment, region, category)
•	📊 Profitability analysis highlighting cost structures and margins
•	🗺️ Geographic insights for state-level sales performance
•	⏳ Short-term forecasting to support inventory and staffing decisions
________________________________________
🎯 Business Impact
•	Identifies top-performing regions and categories for targeted marketing
•	Highlights payment mode trends to optimize transaction strategies
•	Provides forecast-driven planning for inventory and logistics
•	Enables data-backed decision-making for profitability improvement
________________________________________
Future Enhancements
• Integrate Python forecasting models (ARIMA, Prophet) for deeper predictive analytics. • Add dynamic filters for year, region, and segment. • Automate data refresh via Power BI Service. • Include KPI alerts for threshold-based monitoring.
________________________________________
👩‍💻 Author
Abha
Data Analyst | Python & BI Enthusiast | Passionate about turning data into actionable insights
________________________________________
